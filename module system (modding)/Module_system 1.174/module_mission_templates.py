...
#mod events
	...
	##server initial settings, player gold and wave management
	   ...
	   (1,20,0, [(eq, "$g_is_wave_active",0)],[ #increase bot count  if wave is over and there are players in team 2
                ...
                (store_mul, ":bots_startnum", ":are_there_players", 2), #startvalue for 1st wave our c
       ...
       (1,0,0,[(eq, "$g_is_wave_active",2)],[ #despawn horses, some horsemen are kamikaze and deal dmg if mounted near harlaus
       (entry_point_get_position, pos1, 32),
        (try_for_agents, ":agent_no"),
       ...
       #(ti_on_agent_killed_or_wounded, 0,0,[],[ #kill player and respawn him with new equipment if he reached new lvl
