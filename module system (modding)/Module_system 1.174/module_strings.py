...
("the_coast", "the coast"),
  ...
  ("database_error", "ERROR: Database Resultstring does not match format!"),
  ("load_gold_error", "ERROR: Cant load Player Id, Id was invalid!"),													  
  ...
  ("announce_website", "^######################^Server-Rank at skript3400.ddns.net^######################")  
]